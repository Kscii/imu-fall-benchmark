...
def run_doctor(
    *,
    ...
    with reporter.task("Inspecting WSL2, CUDA, and Python runtime"):
        environment = {
            **cuda_environment(),
    ...
    with reporter.task(
        "Checking public model backends",
        total=7,
        unit="models",
    ) as task:
        task.update(detail="threshold_impact")
